...
const STAGES = [
  ...
  },
  {
    ...
    time: "09:00 CET",
    localTime: "09:00",
    title: "Check Out → Drive to Hotel Kirchplatz",
    location: "Landeck → St Anton am Arlberg",
    icon: "🚗",
    type: "drive",
    tagColor: "#ffd93d",
    tag: "20 MIN DRIVE",
    weather: { temp: "1°C → -1°C", condition: "Clear", icon: "☀️", wind: "5 km/h", humidity: "55%" },
    description: "Check out of Hotel Schrofenstein and drive the 20 minutes back to St Anton. Check into Hotel Kirchplatz on Dorfstrasse 73 — right in the heart of the village. This is your base for the rest of the trip (Sat night, Sun night, Mon night). Dump your bags and hit the slopes!",
    wazeUrl: "https://waze.com/ul?ll=47.1297,10.2685&navigate=yes",
    wazeLabel: "Navigate to Hotel Kirchplatz, St Anton",
    walkthrough: [
      "🏨 Check out of Hotel Schrofenstein by 10:00 AM",
      "🛣️ Route: Landeck → S16 West → St Anton (~20 min)",
      "🚇 Arlberg Tunnel toll applies again (~€10-18)",
      "🏨 Hotel Kirchplatz: Dorfstrasse 73, St Anton am Arlberg",
      "🎿 Ski depot: store your gear at the hotel — no need to lug it around",
      "♨️ Sauna available after skiing each day",
      "🍳 Breakfast included — fuel up before hitting the slopes",
      "⛷️ Galzigbahn gondola is a short walk from the hotel — straight onto the mountain"
    ],
    image: "https://images.unsplash.com/photo-1551524559-8af4e6624178?w=800&q=80",
  ...
  },
  {
    ...
    walkthrough: [
      ...
      "🅿️ Follow signs to Car Rental return at the multi-storey car park"
    ],
    image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80",
    imageAlt: "Alpine motorway through mountains"
  },
  {
    ...
    tag: "AIRPORT",
    weather: { temp: "8°C", condition: "Partly Cloudy", icon: "⛅", wind: "10 km/h", humidity: "65%" },
    description: "Return the rental car at the multi-storey car park (same place you picked it up). Walk the covered walkway back to the terminal. Check in for easyJet EZY8696. Small airport so you'll have plenty of time — grab a coffee and a last Austrian pastry.",
    walkthrough: [
      "🚗 Return car: drive to car rental area in multi-storey car park",
      "⛽ Make sure tank is full (or pay the premium — not worth it)",
