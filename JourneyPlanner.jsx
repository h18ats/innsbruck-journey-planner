...
const STAGES = [
  ...
  },
  {
    ...
    tag: "CAR HIRE",
    weather: { temp: "8°C", condition: "Partly Cloudy", icon: "⛅", wind: "10 km/h", humidity: "65%" },
    description: "Collect your Kia Stonic (or similar) from the multi-storey car park. Booked via Booking ref PRE-201495906. Pickup 11:00, return 24 Mar 18:00. Total €287.80 (~£240). Main driver (Andrew) must present credit card, driving licence, and passport.",
    walkthrough: [
      "📋 Booking ref: PRE-201495906",
      "🚗 Car: Kia Stonic 5-door A/C (or similar)",
      "💰 Total: €287.80 (~£240) — prepaid",
      "💳 CREDIT CARD required in main driver's name (Andrew Batty)",
      "🪪 Driving licence: original only — no photocopies",
      "🛂 Passport or ID required at desk",
      "❄️ Winter tyres: MANDATORY Nov–Apr — should already be fitted",
  ...
  },
  {
    ...
    tag: "AIRPORT",
    weather: { temp: "8°C", condition: "Partly Cloudy", icon: "⛅", wind: "10 km/h", humidity: "65%" },
    description: "Return the Kia Stonic at the multi-storey car park (same place you picked it up). Car return deadline is 18:00 — you'll be well ahead of that. Walk the covered walkway back to the terminal. Check in for easyJet EZY8696. Small airport so you'll have plenty of time.",
    walkthrough: [
      "🚗 Return car: drive to car rental area in multi-storey car park",
      "📋 Booking ref: PRE-201495906 — return by 18:00",
...
const TRIP_SUMMARY = {
  ...
  costs: [
    ...
    { item: "Car hire — Kia Stonic 4 days (PRE-201495906)", cost: "€287.80 (~£240)" },
