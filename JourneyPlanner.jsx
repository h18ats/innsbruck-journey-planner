...
const STAGES = [
  ...
  },
  {
    ...
    description: "You've made it to St Anton! First stop: Galzigbahn base station to buy lift passes, then straight on the mountain. Lifts run until 16:30 — you should get a good 2-3 hours in this afternoon. Buy BOTH the half-day AND the 4-day pass now to skip the queue Saturday morning.",
    walkthrough: [
      "🅿️ 12:45 — Park near the Galzigbahn gondola (central car park, follow signs)",
      "🚶 12:50 — Walk to Galzigbahn base station (~5 min from car park)",
      "🎟️ 13:00 — BUY LIFT PASSES at Galzigbahn ticket office or 24/7 machine:",
      ...
      "🍕 13:15 — Quick lunch: grab something fast in the village or eat on the mountain",
      "⛷️ 13:30 — ON THE SLOPES! Galzigbahn gondola up to Galzig (2,185m)",
      "❄️ Snow depth: ~274cm at summit (2,811m), ~71cm at base (1,305m)",
      "🌡️ On-piste: -3°C at altitude, dress in layers",
      "⏰ Lifts close ~16:30 — get 3 hours of skiing in",
