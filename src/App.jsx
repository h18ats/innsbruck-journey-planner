        ...
        React.createElement("div", { style: { maxWidth: 900, margin: "0 auto", padding: "2rem" } },
          ...
          React.createElement("div", { style: { background: "linear-gradient(135deg, rgba(255,107,107,0.08), rgba(255,217,61,0.08))", border: "1px solid rgba(255,107,107,0.2)", borderRadius: 14, padding: "20px 24px", marginBottom: 20 } },
            ...
            React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } },
              ["Passport/ID for all three travellers", "James & Lee: Economy Basic \u2014 no checked bags, no seat selection (add at check-in if needed)", "easyJet check-in opens 30 days before (Feb 22) \u2014 do it early for better seats", "Add passport details to easyJet booking (ref: KBXZJFX)", "easyJet return: 3x 23kg hold bags included, but cabin is SMALL under-seat bag only", "Rental car: confirm winter tyres, vignette, and ask about snow chains", "Arlberg Tunnel toll: ~\u20AC10-18 per trip (not covered by motorway vignette)", "Return flight Tue 24 Mar: leave St Anton by ~4 PM for 6:55 PM flight"].map((note, i) =>
